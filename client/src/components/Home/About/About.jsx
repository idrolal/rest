      ...
      <div className="about-container" id="AboutUs">
        ...
        <div className="about-options">
          ...
          <div className='about-text'>
            <p className="about-p">Что такое <span className='text-span'>eco</span><span className='text-p'>PARK</span>?</p>
            <span className='text-light'>Уединённое место для побега из шумных мегаполисов, возможность
            ...
            контрасте с силой природы ваши впечатления будут лишь ярче.</span>
          </div>
