  ...
  return (
    <>
      ...
      <ul className="collapsible">
        <li>
          <div className="collapsible-header"><img className='collapse-logo' src={right} alt="" /><span className='collapsible-head'>Как осуществить бронь?</span></div>
        ...
        <li>
          <div className="collapsible-header"><img className='collapse-logo' src={right} alt="" /><span className='collapsible-head'>Как добраться?</span></div>
          <div className="collapsible-body">
            <span className='collapse-text'>
